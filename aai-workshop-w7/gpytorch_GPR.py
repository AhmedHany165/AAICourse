...
class GPR():
    ...
    def __init__(self, datafile_train, datafile_test):
        ...
        model, likelihood  = self.evaluate_GPR(X_test, Y_test, model, likelihood, training_time)
        self.plot_GPR(X_train, Y_train, X_test, Y_test, model, likelihood )
    ...
    def evaluate_GPR(self, X_test, Y_test, model, likelihood, training_time):
        ...
        ModelEvaluator.compute_performance(None, Y_true, Y_pred, Y_prob)
